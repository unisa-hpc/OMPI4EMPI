...
#pragma weak MPI_UBcast = PMPI_UBcast
#endif
#define MPI_UBcast PMPI_UBcast
#endif

static const char FUNC_NAME[] = "MPI_UBcast";


int MPI_UBcast(void *buffer, int count, MPI_Datatype datatype,
