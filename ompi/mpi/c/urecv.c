...
#pragma weak MPI_URecv = PMPI_URecv
#endif
#define MPI_URecv PMPI_URecv
#endif

static const char FUNC_NAME[] = "MPI_URecv";


int MPI_URecv(void *buf, int count, MPI_Datatype type, int source,
