...
#pragma weak MPI_IUrecv = PMPI_IUrecv
#endif
#define MPI_IUrecv PMPI_IUrecv
#endif

static const char FUNC_NAME[] = "MPI_IUrecv";


int MPI_IUrecv(void *buf, int count, MPI_Datatype type, int source,
