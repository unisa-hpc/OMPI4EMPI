...
#pragma weak MPI_IUbcast = PMPI_IUbcast
#endif
#define MPI_IUbcast PMPI_IUbcast
#endif

static const char FUNC_NAME[] = "MPI_IUbcast";


int MPI_IUbcast(void *buffer, int count, MPI_Datatype datatype,
