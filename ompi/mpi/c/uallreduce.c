...
#pragma weak MPI_UAllreduce = PMPI_UAllreduce
#endif
#define MPI_UAllreduce PMPI_UAllreduce
#endif

static const char FUNC_NAME[] = "MPI_UAllreduce";


int MPI_UAllreduce(const void *sendbuf, void *recvbuf, int count,
