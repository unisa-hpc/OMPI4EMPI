...
#pragma weak MPI_UAllgather = PMPI_UAllgather
#endif
#define MPI_UAllgather PMPI_UAllgather
#endif

static const char FUNC_NAME[] = "MPI_UAllgather";


int MPI_UAllgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
